...
<img class="d-block mx-auto mb-4" src="https://github.com/mpcgt/hotel-reservations/blob/main/images/hotel.png?raw=true" alt="" width="110" height="100">
    ...
    <div class="col-lg-6 mx-auto">
      ...
      <a href="register.php" type="button" class="btn btn-outline-info">S'inscrire</a>
        ...
        <a href="current_reservations.php" type="button" class="btn btn-outline-danger">Listes des réservations en cours</a>
      </div>
    </div>
  </div>
</div>
